...
const ReactDatePickerWrapper = ({
  ...
  // Configuración del DatePicker con todas las propiedades necesarias
  const datePicker = (
    <DatePicker
  ...
  // Renderizar con o sin label dependiendo de si se proporciona
  if (label) {
    return (
  ...
  // Si no hay label, devolver solo el DatePicker
  return datePicker;
};
