...
import VentaFormulario from '../molecules/VentaFormulario.jsx';
import AddSaleButton from '../molecules/AddSaleButton.jsx';
...
const MainLayout = ({ children, currentPage }) => {
  ...
  const getSelectedKey = () => {
    // Verificar la URL actual para determinar la página activa
    const currentPath = window.location.pathname;
    
    // Mapear rutas a claves de menú
    if (currentPath === '/rendimiento') return ['7'];
    
    // Continuar con la lógica basada en el nombre de la página
    switch (currentPage) {
      case 'Dashboard':
        return ['1'];
      case 'Ventas':
  ...
  return (
    <Layout className="main-layout">
      ...
      >
        ...
        {/* Menú principal de navegación - Filtrado según el rol del usuario */}
        <Menu
          theme="dark"
          mode="inline"
        ...
        <div className="sidebar-footer">
          <Dropdown
            menu={{
              items: [
                // Rendimiento - Solo visible para administradores
                ...(usuario?.rol === 'admin' ? [
                  {
                    key: '7',
